...
/**
 * This is the model class for table "c7z4w_kunena_aliases".
 *
 * The followings are the available columns in table 'c7z4w_kunena_aliases':
 * @property string $alias
 * @property string $type
 * @property string $item
 * @property integer $state
 */
class KunenaAliases extends KunenaActiveRecord
{
...
private $datahelper;
         ...
         */
         public function __construct($scenario = 'insert',$dh=true){
               if($dh)
                $this->datahelper = new DataHelper('KunenaAliases','c7z4w_kunena_aliases');
	 ...
	 * @return KunenaAliases the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
         ...
         public function getAjaxButtons(){
           ...
           $gridid = "KunenaAliases_hybridgrid";
           $hybridgridid = "hybridgrid-".$gridid; 
           $update_view = "KunenaAliases_form";
