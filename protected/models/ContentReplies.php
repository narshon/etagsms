...
/**
 * This is the model class for table "sys_content_replies".
 *
 * The followings are the available columns in table 'sys_content_replies':
 * @property integer $id
 * @property integer $contentin_id
 * @property integer $contentout_id
 *
 * The followings are the available model relations:
 * @property ContentIn $contentin
 * @property ContentOut $contentout
 */
class ContentReplies extends CActiveRecord
{
...
/**
 * @var integer contentin_id
 * @soap
*/
public  $contentin_id;

/**
 * @var integer contentout_id
 * @soap
*/
public  $contentout_id;
...
private $datahelper;
         ...
         */
         public function __construct($scenario = 'insert',$dh=true){
               if($dh)
                $this->datahelper = new DataHelper('ContentReplies','sys_content_replies');
	 ...
	 * @return ContentReplies the static model class
	 */
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
         ...
         public function getAjaxButtons(){
           ...
           $gridid = "ContentReplies_hybridgrid";
           $hybridgridid = "hybridgrid-".$gridid; 
           $update_view = "ContentReplies_form";
           $view_url = Yii::app()->createAbsoluteUrl("automated/view");
           $model = "ContentReplies";
