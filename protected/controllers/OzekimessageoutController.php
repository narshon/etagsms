...
class OzekimessageoutController extends Controller
{
	...
	{       
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','BulkSmsSender'),
				'users'=>array('@'),
			),
        ...
        public function actionBulkSmsSender(){
	...
	{
		$model=new Ozekimessageout;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Ozekimessageout']))
		{
			$model->attributes=$_POST['Ozekimessageout'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Ozekimessageout');
	...
	{
		$model=new Ozekimessageout('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ozekimessageout']))
			$model->attributes=$_GET['Ozekimessageout'];
	...
	{
		$model=Ozekimessageout::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ozekimessageout-form')
		{
