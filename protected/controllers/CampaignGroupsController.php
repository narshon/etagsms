...
class CampaignGroupsController extends Controller
{
	/**
	...
	{
		$model=new CampaignGroups;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['CampaignGroups']))
		{
			$model->attributes=$_POST['CampaignGroups'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('CampaignGroups');
	...
	{
		$model=new CampaignGroups('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CampaignGroups']))
			$model->attributes=$_GET['CampaignGroups'];
	...
	{
		$model=CampaignGroups::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='campaign-groups-form')
		{
