...
class MessageinController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Messagein']))
		{
			$model->attributes=$_POST['Messagein'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Messagein');
	...
	{
		$model=new Messagein('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Messagein']))
			$model->attributes=$_GET['Messagein'];
	...
	{
		$model=Messagein::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='messagein-form')
		{
