...
class KunenaTopicsController extends Controller
{
	/**
	...
	{
		$model=new KunenaTopics;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['KunenaTopics']))
		{
			$model->attributes=$_POST['KunenaTopics'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('KunenaTopics');
	...
	{
		$model=new KunenaTopics('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KunenaTopics']))
			$model->attributes=$_GET['KunenaTopics'];
	...
	{
		$model=KunenaTopics::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kunena-topics-form')
		{
