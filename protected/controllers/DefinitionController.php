...
class DefinitionController extends Controller
{
	...
	{       
                ...
                Definition::model()->showManualPortlets($this);
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','content','panel','index','manageusers'),
				'users'=>array('@'),
			),
        ...
        public function actionPanel(){
             ...
             // attaching dataportlets event handler
                ...
                $this->showDataPortlets($eventManager,'');
	...
	public function actionIndex($id='')
	{
            if($id=='')
              ...
              Definition::setCurrentCampaign($id);
	...
	protected function performAjaxValidation($model)
	{
        ...
        protected function showDataPortlets($eventManager,$attribute){
            
            $event=new CEvent($this, array('controller'=>$this));
