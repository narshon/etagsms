...
class MessageoutController extends Controller
{
	...
	{
		$model=new Messageout;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Messageout']))
		{
			$model->attributes=$_POST['Messageout'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Messageout');
	...
	{
		$model=new Messageout('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Messageout']))
			$model->attributes=$_GET['Messageout'];
	...
	{
		$model=Messageout::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='messageout-form')
		{
