...
class SmsIncomingController extends Controller
{
	...
	{
		$model=new SmsIncoming;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SmsIncoming']))
		{
			$model->attributes=$_POST['SmsIncoming'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('SmsIncoming');
	...
	{
		$model=new SmsIncoming('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SmsIncoming']))
			$model->attributes=$_GET['SmsIncoming'];
	...
	{
		$model=SmsIncoming::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sms-incoming-form')
		{
