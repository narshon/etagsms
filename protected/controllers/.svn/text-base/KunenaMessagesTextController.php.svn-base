...
class KunenaMessagesTextController extends Controller
{
	/**
	...
	{
		$model=new KunenaMessagesText;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['KunenaMessagesText']))
		{
			$model->attributes=$_POST['KunenaMessagesText'];
			if($model->save()){
                            if (Yii::app()->request->isAjaxRequest)
                            {
                                ...
                                $this->redirect(array('view','id'=>$model->mesid));
                        }
	...
	{
		$dataProvider=new CActiveDataProvider('KunenaMessagesText');
	...
	{
		$model=new KunenaMessagesText('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KunenaMessagesText']))
			$model->attributes=$_GET['KunenaMessagesText'];
	...
	{
		$model=KunenaMessagesText::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kunena-messages-text-form')
		{
