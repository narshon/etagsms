...
class EmailOutgoingController extends Controller
{
	/**
	...
	{
		$model=new EmailOutgoing;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['EmailOutgoing']))
		{
			$model->attributes=$_POST['EmailOutgoing'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('EmailOutgoing');
	...
	{
		$model=new EmailOutgoing('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EmailOutgoing']))
			$model->attributes=$_GET['EmailOutgoing'];
	...
	{
		$model=EmailOutgoing::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='email-outgoing-form')
		{
