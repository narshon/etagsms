...
class KunenaMessagesController extends Controller
{
	/**
	...
	{
		$model=new KunenaMessages;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['KunenaMessages']))
		{
			$model->attributes=$_POST['KunenaMessages'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('KunenaMessages');
	...
	{
		$model=new KunenaMessages('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KunenaMessages']))
			$model->attributes=$_GET['KunenaMessages'];
	...
	{
		$model=KunenaMessages::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kunena-messages-form')
		{
