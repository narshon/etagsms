...
class ProcessHandlerController extends Controller
{
	/**
	...
	{
		$model=new ProcessHandler;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ProcessHandler']))
		{
			$model->attributes=$_POST['ProcessHandler'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('ProcessHandler');
	...
	{
		$model=new ProcessHandler('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProcessHandler']))
			$model->attributes=$_GET['ProcessHandler'];
	...
	{
		$model=ProcessHandler::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='process-handler-form')
		{
