...
class CampaignOwnerController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CampaignOwner']))
		{
			$model->attributes=$_POST['CampaignOwner'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('CampaignOwner');
	...
	{
		$model=new CampaignOwner('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CampaignOwner']))
			$model->attributes=$_GET['CampaignOwner'];
	...
	{
		$model=CampaignOwner::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='campaign-owner-form')
		{
