...
class ContentRepliesController extends Controller
{
	...
	{
		$model=new ContentReplies;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ContentReplies']))
		{
			$model->attributes=$_POST['ContentReplies'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('ContentReplies');
	...
	{
		$model=new ContentReplies('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ContentReplies']))
			$model->attributes=$_GET['ContentReplies'];
	...
	{
		$model=ContentReplies::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='content-replies-form')
		{
