...
class OzekimessageinController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ozekimessagein']))
		{
			$model->attributes=$_POST['Ozekimessagein'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Ozekimessagein');
	...
	{
		$model=new Ozekimessagein('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ozekimessagein']))
			$model->attributes=$_GET['Ozekimessagein'];
	...
	{
		$model=Ozekimessagein::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ozekimessagein-form')
		{
