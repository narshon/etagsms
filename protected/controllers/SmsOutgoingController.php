...
class SmsOutgoingController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SmsOutgoing']))
		{
			$model->attributes=$_POST['SmsOutgoing'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('SmsOutgoing');
	...
	{
		$model=new SmsOutgoing('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SmsOutgoing']))
			$model->attributes=$_GET['SmsOutgoing'];
	...
	{
		$model=SmsOutgoing::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sms-outgoing-form')
		{
