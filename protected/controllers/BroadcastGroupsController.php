...
class BroadcastGroupsController extends Controller
{
	/**
	...
	{       
        ...
        public function actionRemove($id,$string=''){
            if($id){
	...
	{
		$model=new BroadcastGroups;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['BroadcastGroups']))
		{
			$model->attributes=$_POST['BroadcastGroups'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('BroadcastGroups');
	...
	{
		$model=new BroadcastGroups('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BroadcastGroups']))
			$model->attributes=$_GET['BroadcastGroups'];
	...
	{
		$model=BroadcastGroups::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='broadcast-groups-form')
		{
