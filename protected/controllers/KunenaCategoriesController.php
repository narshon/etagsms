...
class KunenaCategoriesController extends Controller
{
	/**
	...
	{
		$model=new KunenaCategories;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['KunenaCategories']))
		{
			$model->attributes=$_POST['KunenaCategories'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('KunenaCategories');
	...
	{
		$model=new KunenaCategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KunenaCategories']))
			$model->attributes=$_GET['KunenaCategories'];
	...
	{
		$model=KunenaCategories::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kunena-categories-form')
		{
