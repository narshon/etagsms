...
class AlerterController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Alerter'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Alerter');
	...
	{
		$model=new Alerter('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Alerter']))
			$model->attributes=$_GET['Alerter'];
	...
	{
		$model=Alerter::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='alerter-form')
		{
