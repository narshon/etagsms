...
class UsersController extends Controller
{
	...
	{       
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','elevateuser','delevateuser'),
				'users'=>array('@'),
			),
        ...
        public function actionelevateuser($id){
            $model = $this->loadModel($id);
            $model->elevateuser();
        }
        public function actiondelevateuser($id){
            $model = $this->loadModel($id);
            $model->delevateuser();
        }
	...
	{
		$div = $this->renderPartial('view',array(
			'model'=>$this->loadModel($id),
		),true,false);
