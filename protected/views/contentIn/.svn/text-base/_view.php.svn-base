<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('in_msg_id')); ?>:</b>
	<?php echo CHtml::encode($data->in_msg_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('msg_datetime')); ?>:</b>
	<?php echo CHtml::encode($data->msg_datetime); ?>
	<br />
