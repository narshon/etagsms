...
<div id="view-title">SMS Outbox</div>
<div id="view-details">
<?php
if($this->beginCache("smsoutbox", array('dependency'=>array(
    ...
    print '<div id="outgoing-sms-stream" class="view">';
      //outgoing-sms-stream
    $this->renderPartial('//contentOut/admin',(array('campaign_id'=>$id,'title'=>'','channel'=>'sms','status'=>'sent')),false,true);
    print  "</div>";
/*
