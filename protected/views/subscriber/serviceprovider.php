...
<div id="view-title">Service Provider Incoming SMS</div>
<div id="view-details">
<?php
if($this->beginCache("smsunprocessed", array('dependency'=>array(
    ...
    print '<div id="outgoing-sms-stream" class="view">';
      //outgoing-sms-stream
    $this->renderPartial('../smsIncoming/admin',(array('status'=>'pending','source'=>'Safaricom','dest'=>Organisation::model()->getCampaignOrganisationName($id))),false,true);
    print  "</div>";
